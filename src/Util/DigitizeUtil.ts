...
export class DigitizeUtil {
  ...
  static getDigitizeLayer(map: OlMap, layerName: string): OlVectorLayer {
    let digitizeLayer = MapUtil.getLayerByName(map, layerName);
    ...
    if (!digitizeLayer) {
      ...
      digitizeLayer.set('name', layerName);
