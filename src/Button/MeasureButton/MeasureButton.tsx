...
export const MeasureButton: FC<MeasureButtonProps> = ({
  ...
  const drawInteraction = useOlInteraction(() => new OlInteractionDraw({
    source: measureLayer?.getSource() || undefined,
    type: measureType === 'polygon' ? 'MultiPolygon' : 'MultiLineString',
  ...
  }, [decimalPlacesInTooltips, feature, geodesic, map, measureTooltip, measureType]);
