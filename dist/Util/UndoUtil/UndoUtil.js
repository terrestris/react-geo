 ...
 * @class
 */
var UndoUtil = exports.UndoUtil = function () {
  function UndoUtil() {
    _classCallCheck(this, UndoUtil);
  }

  _createClass(UndoUtil, null, [{
    key: "atLeastOneUndoable",
     ...
     */
    value: function atLeastOneUndoable(state) {
    ...
    key: "atLeastOneRedoable",
    value: function atLeastOneRedoable(state) {
